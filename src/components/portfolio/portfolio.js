...
const PORTFOLIO = () => {
  ...
  const projects = [
    { 
        id: 1,
        name: 'Foodie-Fetch', 
        description: 'An application that allows users to find recipes based on culinary preferences and dietary restrictions.', 
    ...
    { 
        id: 2, 
        name: 'Quickdecks', 
        description: 'Quickdecks is an application where users can review and test their learning by creating flashcards and quizzes for their subjects of choice.', 
    ...
    { 
        ...
        description: 'This application is an e-commerce back end that uses ORM to interact with a MySQL database', 
    ...
    { 
        ...
        description: 'This is a simple employee tracker program written in Node.js. It allows you to keep track of your company\'s employees, including their names, roles, salaries, and departments.', link:'https://github.com/stephen-castillo/Employee-Tracker',
        img: IMG5 
    },
    { 
        id: 6, 
        name: 'Readme-Generator', 
        description: 'A simple program that quickly generates a profession project readme', 
